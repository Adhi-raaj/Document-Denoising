...
> Removes coffee stains, ink bleeds, and noise from scanned historical documents using a Denoising Convolutional Autoencoder trained on the [Kaggle Denoising Dirty Documents](https://www.kaggle.com/c/denoising-dirty-documents) dataset.
...
|:---:|:---:|
| ![noisy](assets/noisy_example.png) | ![clean](assets/clean_example.png) |
...
1. Open `Document_Denoising_Colab.ipynb` in [Google Colab](https://colab.research.google.com)
...
3. Upload it when prompted in the Colab notebook (Step 3)
...
```
Document Denoising for Archival Papers | PyTorch, Flask | 2025
Built a U-Net Denoising Autoencoder to clean coffee stains and ink bleeds
from scanned historical documents. Trained on Kaggle dataset with patch-based
pipeline, achieving PSNR >30 dB. Deployed via Flask web app with CPU-optimized
